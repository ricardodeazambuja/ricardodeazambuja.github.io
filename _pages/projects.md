...
## Active
- [ ] [tui-driver - Drive any interactive TUI from a shell script via tmux](https://github.com/ricardodeazambuja/tui-driver)
- [ ] [Curatables - Self-hosted, ad-free curated video server for kids](https://github.com/MadeByTokens/curatables)
- [ ] [Free X-Stitch Editor - Browser-based cross-stitch pattern editor](https://stitchadee.ca/)
- [ ] [Running Gemma4 26B on an 8GB-VRAM laptop](https://github.com/ricardodeazambuja/gemma4-26B-only-8B-VRAM)

## Past
- [x] [Flexi Banana Case - 3D-printed model](https://www.printables.com/model/1745732-flexi-banana-case)
- [x] [The CogniFly Project](https://thecognifly.github.io/)
- [x] [Maple Syrup Pi Camera](https://github.com/ricardodeazambuja/Maple-Syrup-Pi-Camera)
- [x] [MKS Servo42D CAN Control Project](https://github.com/ricardodeazambuja/mks_servo_can)
- [x] [Barcode Tool - Generator & Scanner](https://ricardodeazambuja.com/barcodetool/)
- [x] [colab_utils](https://github.com/ricardodeazambuja/colab_utils)
- [x] [libredgetpu - Pure-Python Edge TPU driver (compute beyond ML inference)](https://github.com/ricardodeazambuja/libredgetpu)
- [x] [EdgeTPUOnModernRPIs - Run Coral Edge TPU on modern Raspberry Pi OS (Trixie)](https://github.com/ricardodeazambuja/EdgeTPUOnModernRPIs)
- [x] [deobfuscate-mcp-server - MCP server to help LLMs reverse-engineer minified JS](https://github.com/MadeByTokens/deobfuscate-mcp-server)
- [x] [SynthAndI - Browser retro synthesizer + gamified learning PWA](https://github.com/ricardodeazambuja/SynthAndI)
- [x] [Protoface - Facial animation web app (speech + cartoon modes)](https://ricardodeazambuja.com/protoface)
- [x] [image2ttf - Create fonts from images](https://madebytokens.github.io/image2ttf/)
- [x] [ROS 2 Turtle School - Install-free ROS 2 emulator for tutorials](https://github.com/MadeByTokens/ros2-turtle-school)
...
- [x] [Chaos Chess](https://ricardodeazambuja.com/chaos_chess/)
- [x] [Pochibete](https://ricardodeazambuja.com/pochibete/)
